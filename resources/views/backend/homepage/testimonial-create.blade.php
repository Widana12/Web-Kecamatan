...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.homepage.testimonials') }}">Data Perangkat Kecamatan</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.homepage.testimonial.store') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="sub_name" class="col-sm-2 col-form-label fw-bolder text-uppercase">Divisi</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('sub_name') is-invalid @enderror" name="sub_name" id="sub_name" placeholder="Divisi" value="{{ old('sub_name') }}">
                                @error('sub_name')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <label for="content" class="col-sm-2 col-form-label fw-bolder text-uppercase">Nip</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('content') is-invalid @enderror" name="content" id="content" placeholder="Nip" value="{{ old('content') }}">
                                @error('content')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
