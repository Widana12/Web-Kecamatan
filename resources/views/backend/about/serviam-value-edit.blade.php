...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.about.serviam.index') }}">Indormasi Pelayanan</a></li>
            <li class="breadcrumb-item active" aria-current="page">Ubah Informasi Pelayanan</li>
        </ol>
    </nav>

    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <div>
            <h3 class="mb-md-0 fw-bolder text-uppercase mb-3">Ubah Informasi Pelayanan</h3>
        </div>
    </div>
